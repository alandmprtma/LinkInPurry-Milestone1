...
// Update status lowongan menjadi terbuka
$query = "UPDATE Lowongan SET is_open = TRUE WHERE lowongan_id = :lowongan_id AND company_id = :company_id";
$stmt = $pdo->prepare($query);
$stmt->execute(['lowongan_id' => $lowongan_id, 'company_id' => $_SESSION['user_id']]);

// Setelah membuka lowongan, arahkan kembali ke halaman detail lowongan
